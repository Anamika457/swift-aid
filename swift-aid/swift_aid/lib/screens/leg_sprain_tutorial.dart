...
class LegSprainTutorialScreen extends StatefulWidget {
  const LegSprainTutorialScreen({super.key});

  @override
  State<LegSprainTutorialScreen> createState() => _LegSprainTutorialScreenState();
}

class _LegSprainTutorialScreenState extends State<LegSprainTutorialScreen> {
  ...
  final List<Map<String, String>> _steps = [
  {
    "title": "Step 1 of 5",
    "desc":
        "Have the person stop using the injured leg immediately. Help them sit or lie down to avoid further strain."
  },
  {
    "title": "Step 2 of 5",
    "desc":
        "Apply a cold pack or cloth-wrapped ice to the sprained area for 15–20 minutes to reduce swelling and pain."
  },
  {
    "title": "Step 3 of 5",
    "desc":
        "Wrap the leg with an elastic bandage to provide compression. Make sure it's snug but not tight enough to cut off circulation."
  },
  {
    "title": "Step 4 of 5",
    "desc":
        "Raise the injured leg on pillows or any elevated surface to reduce swelling. Keep it elevated as much as possible."
  },
  {
    "title": "Step 5 of 5",
    "desc":
        "Avoid putting weight on the leg until the pain improves. Seek medical help if swelling is severe or the person cannot stand."
  },
];
  ...
  Future<void> _loadModelAsHtml() async {
    try {
      final bytes = await rootBundle.load('assets/leg_sprain.glb');
