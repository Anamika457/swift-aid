...
class ARLegSprainWidget extends StatefulWidget {
  const ARLegSprainWidget({Key? key}) : super(key: key);
  @override
  State<ARLegSprainWidget> createState() => _MyARWidgetState();
}
class _MyARWidgetState extends State<ARLegSprainWidget> {
...
Future<void> onRemoveEverything() async {
  ...
  Future<void> onPlaneOrPointTapped(List<ARHitTestResult> hitTestResults) async {
    ...
    final node = ARNode(
      ...
      uri: 'assets/leg_sprain/leg_sprain.gltf', 
