...
class ARNoseBleedWidget extends StatefulWidget {
  const ARNoseBleedWidget({Key? key}) : super(key: key);
  @override
  State<ARNoseBleedWidget> createState() => _MyARWidgetState();
}
class _MyARWidgetState extends State<ARNoseBleedWidget> {
...
Future<void> onRemoveEverything() async {
  ...
  Future<void> onPlaneOrPointTapped(List<ARHitTestResult> hitTestResults) async {
    ...
    final node = ARNode(
      ...
      uri: 'assets/nose_bleed/nosebleed.gltf', 
