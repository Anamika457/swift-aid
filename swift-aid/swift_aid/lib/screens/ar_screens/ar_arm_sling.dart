...
class ARArmSlingWidget extends StatefulWidget {
  const ARArmSlingWidget({Key? key}) : super(key: key);
  @override
  State<ARArmSlingWidget> createState() => _MyARWidgetState();
}
class _MyARWidgetState extends State<ARArmSlingWidget> {
...
Future<void> onRemoveEverything() async {
  ...
  Future<void> onPlaneOrPointTapped(List<ARHitTestResult> hitTestResults) async {
    ...
    final node = ARNode(
      ...
      uri: 'assets/arm_sling/arm_sling.gltf', 
